...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kocknet Emmanuella — Machine Learning Engineer" },
      {
        name: "description",
        content:
          "Machine Learning Engineer building intelligent systems from data to deployment.",
      },
      { name: "author", content: "Kocknet Emmanuella" },
